...
class RegisterTest extends TestCase
{
    ...
    public function for_registration_email_must_be_real_email()
    {
        ...
        $this->assertEquals(session('errors')->get('email')[0], 'The email field must be a valid email address.');
    }
    ...
    public function for_registration_password_must_be_min_of_8_chars()
    {
        ...
        $this->assertEquals(session('errors')->get('password')[0], 'The password field must be at least 8 characters.');
    }
    ...
    public function for_registration_name_must_be_max_of_25_chars()
    {
        ...
        $this->assertEquals(session('errors')->get('name')[0], 'The name field must not be greater than 25 characters.');
    }
